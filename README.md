...
## **Intitulé du projet :** Base de donnée sur le foot

**Année :** 2024/2025

**Description succincte du projet :**

Création d’une base de donnée, en plusieurs étapes :
...
**Résultats :**
La base de données répond aux exigences.
...
**Résultats :**
Le site a été fini avec succès. Il est présentable.
...
**Aptitudes personnelles développées :**
Créativité, résolution de problèmes divers.
...
Création d’un programme permettant de générer et de résoudre des sudokus.
...
**Résultats :**
Le solveur/générateur a été fini avec succès. Il permet de générer et de résoudre des sudokus de taille allant de 2*2 à 16*16 et n’étant pas forcément carrés.
...
Création d’un programme permettant de chiffrer un texte via l’utilisation du carré de Polybe, du chiffrement de césar, du ROT13, du ROT47, du chiffre de Vigenère et d’un nombre conséquent de variantes de ces moyens de chiffrement.
 Réalisé en 5 mois et incluant un carnet de bord, une définition du projet, un cahier de tests, des objectifs opérationnels et un mode d’emploi.
...
Création d’un modpack minecraft :
 - supprimer certains crafts,
 - cacher certains items,
 - supprimer certains minerais
 - créer des crafts
 - créer des items

**Cadre :**
Réaliser en monôme dans le cadre d’un projet personnel en avril 2024.

**Technologies :**
Utilisation (et découverte) de Visual Studio Code et de GitHub. Programmé avec json et zenscript
Utilisation de l’outil KubeJS

**Résultats :**
Le GitHub n’est pas à jour et j’ai perdu le code source mais le modpack est fonctionnel. J’ai changé d’outil pendant le projet pour pouvoir mettre le modpack sur un serveur en ligne car le serveur ne supportait pas KubeJS.
